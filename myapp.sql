...
--
-- Host: localhost
-- Generation Time: Jan 21, 2025 at 01:19 AM
...
(4, '2025_01_07_153011_create_customers_table', 1),
(5, '2025_01_07_153050_create_categories_table', 1),
(6, '2025_01_07_153109_create_products_table', 1),
(7, '2025_01_07_153138_create_invoices_table', 1),
(8, '2025_01_07_153207_create_invoice_products_table', 1),
(9, '2025_01_14_195007_create_personal_access_tokens_table', 1);
...
CREATE TABLE `products` (
  ...
  `img_url` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL,
  `created_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `updated_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
('252uxsWz7iTaOuUmUtKpGJTJ9QovF2qAUTMP0oRe', NULL, '127.0.0.1', 'PostmanRuntime/7.43.0', 'YToyOntzOjY6Il90b2tlbiI7czo0MDoiOEV2Q29iNk9VR0RBa2pzTVgyMTlySW1hUzI2ZnlKSG5qTkVndWdQbSI7czo2OiJfZmxhc2giO2E6Mjp7czozOiJvbGQiO2E6MDp7fXM6MzoibmV3IjthOjA6e319fQ==', 1737421226),
('aTTnUWIuqcxUaGQMLb4cAaYe6AvrADEOkOC4R26h', NULL, '127.0.0.1', 'PostmanRuntime/7.43.0', 'YToyOntzOjY6Il90b2tlbiI7czo0MDoiT1BpTmppNlZDOU81WTJCVkVKdjdYeTFzekpFajVYcEViZnVkUWxpWSI7czo2OiJfZmxhc2giO2E6Mjp7czozOiJvbGQiO2E6MDp7fXM6MzoibmV3IjthOjA6e319fQ==', 1737422224),
('EiMuMzkubRefP7KjOfpgd8MNqhiazkfyf8M4oADu', NULL, '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Herd/1.14.0 Chrome/120.0.6099.291 Electron/28.2.5 Safari/537.36', 'YTozOntzOjY6Il90b2tlbiI7czo0MDoiRERTVGdnMGNoakYzVDJURFBmWUdhSVNKUlF0QThyNHBFb2ZnUjM5VCI7czo5OiJfcHJldmlvdXMiO2E6MTp7czozOiJ1cmwiO3M6MzE6Imh0dHA6Ly9teWFwcC50ZXN0Lz9oZXJkPXByZXZpZXciO31zOjY6Il9mbGFzaCI7YToyOntzOjM6Im9sZCI7YTowOnt9czozOiJuZXciO2E6MDp7fX19', 1737420673);
...
(1, 'Rima', '01254', '0', 'arrowanwar@gmail.com', NULL, 'arrowanwar@gmail.com', NULL, '2025-01-15 09:24:20', '2025-01-20 19:17:04');
